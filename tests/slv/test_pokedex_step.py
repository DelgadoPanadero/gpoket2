...
def make_pokemon(name="poke.png", generation="gen3", h=64, w=64):
    ...
    return PokemonEntity(name=name, generation=generation, game_name="firered", image=image)
...
def make_step(pokemon_list=None):
    ...
    return PokedexStep(pokemon_repository=pokemon_repo, pokedex_repository=pokedex_repo), pokedex_repo
